    ...
    <Container id="hero" className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-violet-600">
          ...
          <span className="relative">deals faster</span>
        </span>{' '}
        with collaborative microsites.
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        Auto-personalized, interactive & trackable spaces created in minutes.
        From cold outreach to onboarding hand-off.
      </p>
      ...
      <div className="mt-36 lg:mt-44">
        <p className="font-display text-base text-slate-900">
          They are already accelerating their sales cycles
        </p>
        <ul
          role="list"
